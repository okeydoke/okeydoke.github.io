...
if (typeof mboxVersion == 'undefined') {
	...
	var mboxFactoryDefault = new mboxFactory('lululemonusa.tt.omtrdc.net',
			'lululemonusa', 'default');
};
if (mboxGetPageParameter("mboxDebug") != null
	...
	document
			.write('<'
					...
					+ '"http://admin3.testandtarget.omniture.com/admin/mbox/mbox_debug.jsp?mboxServerHost=lululemonusa.tt.omtrdc.net'
					+ '&clientCode=lululemonusa"><' + '\/scr' + 'ipt>');
};